 ...
 */
class TipoProducto extends \InventarioBundle\Entity\TipoProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'InventarioBundle\\Entity\\TipoProducto' . "\0" . 'id', '' . "\0" . 'InventarioBundle\\Entity\\TipoProducto' . "\0" . 'nombre', '' . "\0" . 'InventarioBundle\\Entity\\TipoProducto' . "\0" . 'productos');
        }
