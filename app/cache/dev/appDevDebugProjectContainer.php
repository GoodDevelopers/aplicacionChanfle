...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'chanfle_bd', 'user' => 'root', 'password' => 'rootA', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\VentasBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\InventarioBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\UsuariosBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\CostosBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\JornadasLaboralesBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AppBundle\\Entity');
        $c->addDriver($b, 'VentasBundle\\Entity');
        $c->addDriver($b, 'InventarioBundle\\Entity');
        $c->addDriver($b, 'UsuariosBundle\\Entity');
        $c->addDriver($b, 'CostosBundle\\Entity');
        $c->addDriver($b, 'JornadasLaboralesBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'VentasBundle' => 'VentasBundle\\Entity', 'InventarioBundle' => 'InventarioBundle\\Entity', 'UsuariosBundle' => 'UsuariosBundle\\Entity', 'CostosBundle' => 'CostosBundle\\Entity', 'JornadasLaboralesBundle' => 'JornadasLaboralesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_69f23e2b7234eff15d70e64cf149ae9be84c704ef8492274162b133037462d78');
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'KnpPaginatorBundle:Pagination:twitter_bootstrap_v3_pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 8));
    }
    ...
    {
        return $this->services['knp_snappy.image'] = new \Knp\Bundle\SnappyBundle\Snappy\LoggableGenerator(new \Knp\Snappy\Image(($this->targetDirs[2].'/../vendor/h4cc/wkhtmltopdf/bin/wkhtmltopdf.exe'), array(), array()), $this->get('monolog.logger.snappy', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['knp_snappy.pdf'] = new \Knp\Bundle\SnappyBundle\Snappy\LoggableGenerator(new \Knp\Snappy\Pdf(($this->targetDirs[2].'/../vendor/h4cc/wkhtmltopdf/bin/wkhtmltopdf.exe'), array(), array()), $this->get('monolog.logger.snappy', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/registros');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/clientes/');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ingresosMateriaPrima/');
        ...
        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/empleados/');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reportes/');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/materiaprima/');
        ...
        $u->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => 'caja_index', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('goodevelopers@gmail.com');
        $a->setPassword('ProyectoAdmin');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CostosBundle/Resources/views'), 'Costos');
        $instance->addPath(($this->targetDirs[3].'\\src\\JornadasLaboralesBundle/Resources/views'), 'JornadasLaborales');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f54c7e558d91315af1536b71548080a614db37ad');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CostosBundle' => 'CostosBundle\\CostosBundle',
                'JornadasLaboralesBundle' => 'JornadasLaboralesBundle\\JornadasLaboralesBundle',
            ...
            'mailer_user' => 'goodevelopers@gmail.com',
            'mailer_password' => 'ProyectoAdmin',
            'secret' => 'f54c7e558d91315af1536b71548080a614db37ad',
            'locale' => 'en',
            ...
            'kernel.secret' => 'f54c7e558d91315af1536b71548080a614db37ad',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'goodevelopers@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'ProyectoAdmin',
            ...
            'knp_snappy.pdf.binary' => ($this->targetDirs[2].'/../vendor/h4cc/wkhtmltopdf/bin/wkhtmltopdf.exe'),
            ...
            'knp_snappy.image.binary' => ($this->targetDirs[2].'/../vendor/h4cc/wkhtmltopdf/bin/wkhtmltopdf.exe'),
