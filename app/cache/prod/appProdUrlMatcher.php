    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/c')) {
            ...
            if (0 === strpos($pathinfo, '/clientes')) {
                ...
                // clientes_buscar
                if (0 === strpos($pathinfo, '/clientes/find') && preg_match('#^/clientes/find/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_clientes_buscar;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'clientes_buscar')), array (  '_controller' => 'UsuariosBundle\\Controller\\ClienteController::buscarAction',));
                }
                not_clientes_buscar:
